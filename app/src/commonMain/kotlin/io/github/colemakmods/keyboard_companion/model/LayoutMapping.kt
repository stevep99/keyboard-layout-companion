...
private val log = Logger.withTag("LayoutMapping")
...
class LayoutMapping(private val layers: List<Layer>) {
    ...
    companion object {
        ...
        val FORMAT_SIMPLE = arrayOf(
            arrayOf("AD01", "AD02", "AD03", "AD04", "AD05", "AD06", "AD07", "AD08", "AD09", "AD10", "AD11", "AD12"),
            arrayOf("AC01", "AC02", "AC03", "AC04", "AC05", "AC06", "AC07", "AC08", "AC09", "AC10", "AC11"),
            arrayOf("AB01", "AB02", "AB03", "AB04", "AB05", "AB06", "AB07", "AB08", "AB09", "AB10")
        )
        val FORMAT_MAIN = arrayOf(
            arrayOf("AE01", "AE02", "AE03", "AE04", "AE05", "AE06", "AE07", "AE08", "AE09", "AE10", "AE11", "AE12"),
            arrayOf("AD01", "AD02", "AD03", "AD04", "AD05", "AD06", "AD07", "AD08", "AD09", "AD10", "AD11", "AD12"),
            arrayOf("AC01", "AC02", "AC03", "AC04", "AC05", "AC06", "AC07", "AC08", "AC09", "AC10", "AC11"),
            arrayOf("AB01", "AB02", "AB03", "AB04", "AB05", "AB06", "AB07", "AB08", "AB09", "AB10")
        )
            ...
            for (col in row.indices) {
                ...
                if (DEFAULT_LABEL != token) {
                    ...
                    if (keyId != null) {
                        ...
                        //log.d("labels: '${currentLayer.name}' : $keyId  $label")
                    }
                }
            }
        }
            ...
            for (col in row.indices) {
                ...
                if (BLANK_LABEL != color) {
                    ...
                    if (keyId != null) {
                        ...
                        log.d( "labels: '${currentLayer.name}' : $keyId $color")
                    }
                }
            }
        }
